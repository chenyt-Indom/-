...
火车票link：https://kyfw.12306.cn/otn/leftTicket/init"""
    else:
        flight_info = f"""
...
【预订卡片班次同步-最高优先级】flights 数组中的 suggest 字段必须包含与上面完全一致的航班号/车次号！
  ...
  ④ link 使用正确链接：机票用 https://flights.ctrip.com/booking/{departure_city}-{dest}-day-1.html，火车票用 https://kyfw.12306.cn/otn/leftTicket/init
...
2. flights中机票link使用 https://flights.ctrip.com/booking/{departure_city}-{dest}-day-1.html，火车票link使用 https://kyfw.12306.cn/otn/leftTicket/init
